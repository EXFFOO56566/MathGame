...
j=0;
score=0;
//Dont forget to star this project on github creds to the original tutor on youtube
...
/* Level 1 */
	{
		cout << "LEVEL 1 : Adding Quiz ( YOU HAVE 5 SECS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
		Beep(0,4000);
		for ( int i=1; i<=5; i++)
		{
			srand(time(0));
			 ...
			 else
			{
    			...
    			else if ( numInput == A+B ) cout << " GOOD!!!!\n\n";
    			else
				{
					cout << "Wrong Answer haha!!";
					j=2;
				}
			}
			if (j==2) break;
...
/* Level 2 */
		...
		{
		cout << "LEVEL 2 : Subtracting Quiz ( YOU HAVE 5 SECS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
		Beep(0,4000);
		for ( int i=1; i<=5; i++)
		{
			srand(time(0));
...
/* Level 3  */
		...
		for (int Y=1 ; j!=2 && Y!=2 ; Y++)
		{
		cout << "LEVEL 3 : Multiplication Quiz ( YOU HAVE 5 SECS TO SOLVE EACH QUESTION )\n-----------------------------------------------------------------------\n\n";
		Beep(0,4000);
		for ( int i=1; i<=5; i++)
		{
			srand(time(0));
